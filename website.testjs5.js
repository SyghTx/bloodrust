...
curcontent["skipqueue"] = {
	...
	<span>Если вас не пропускает вне очереди - проверьте на с того ли аккаунта вы авторизировались на этом сайте и приобрели привилегию, а так-же учтите, привилегия работает только на том сервере где была забрана из корзины.</div></div>'
};
