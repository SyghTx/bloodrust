...
curcontent["skipqueue"] = {
	...
	<span>Если вас не пропускает вне очереди - проверьте с того ли аккаунта вы авторизировались на этом сайте, а так-же учтите, привилегия работает только на том сервере где была забрана из корзины.</div></div>'
};
