...
<p><li>Запрещено использовать/хранить читы/макросы или любой другой софт дающий преимущество перед честными игроками. Наличие покупки или подписки приравнивается к хранению стороннего ПО.</li></p>\
<p><li>Запрещена игра с читерами/макросниками.</li></p>\
<p><li>Запрещено использование любых видов багов с целью или без цели получения преимущества над другими игроками.</li></p>\
...
<input class="spoil-button" type="checkbox" tabindex="-1">\
	 ...
	 <blockquote class="spoil-Untext">Чтобы пополнить баланс необходимо перейти перейти на страницу обмена (нажав на кнопку снизу), выбрать скины которыми хотите пополнить, нажать кнопку "Предложить обмен" и подтвердить обмен через мобильное приложение Steam.<br><br>Если в течении 30 минут предметы не будут приняты или приняты, но баланс не пополнился - обязательно свяжитесь с нами через личные сообщения группы ВК или напрямую с администраторами в дискорде.<div class="btn-skins"><a class="btn-skin" href="https://steamcommunity.com/tradeoffer/new/?partner=240505979&token=aWNwXIAs" target="_blank">Начать обмен</a></blockquote>\
     </div></div><div class="row-skins"><a class="container-user" href="https://vk.com/im?sel=-113458740" target="_blank"><img alt="" src="https://i.imgur.com/dVKXJeW.png" class="icon-user"><div class="textContainer-user"><span class="name-user">Группа ВК</span><span class="category-user">Для связи</span></div></a><a class="container-user1" href="https://discord.gg/ynRjAtTUvJ" target="_blank"><img alt="" src="https://i.imgur.com/PYUeZt9.png" class="icon-user1"><div class="textContainer-user1"><span class="name-user1">Дискорд сервер</span><span class="category-user1">Для связи</span></div></a>'
};
