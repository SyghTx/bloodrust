...
curcontent["skipqueue"] = {
	...
	xcon: '<p><span class="rules_rule">Вход без очереди работает сразу после покупки привилегии (как и написано в её описании), для этого не нужно ничего активировать, но после входа в течении 10 минут необходимо забрать привилегию из корзины.</p>\
<p><span class="rules_rule">Если привилегия была приобретена пока вы стояли в очереди - нужно выйти из очереди и подключится к серверу вновь.</p></div>'
};
