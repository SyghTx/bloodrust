...
curcontent["skipqueue"] = {
	...
	xcon: '<p><span>Вход без очереди работает сразу после покупки привилегии (как и написано в её описании), для этого не нужно ничего активировать, но после входа (в течении 10 минут), необходимо забрать привилегию из корзины. Если привилегия была приобретена пока вы стояли в очереди - нужно выйти из очереди и подключится к серверу вновь.</p>\
	<p><span>Если вас не пропускает вне очереди - проверьте на с того ли аккаунта вы авторизировались на этом сайте и приобрели привилегию, а так-же учтите, привилегия работает только на том сервере где была забрана из корзины.</p></div>'
};
