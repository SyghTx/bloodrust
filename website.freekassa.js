...
<label for="fk-donation-amount" class="qiwi-inp-oplata" id="qiwi-inp-other">\
	<div class="qiwi-widget-title">FreeKassa<br><p>множество способов пополнения</p></div>\
	<div class="qiwi-inp-box">\
			...
			<input type="hidden" name="m" value="10621">\
...
function freekassaHandler(e){
	...
	document.getElementById('fk-donation-sign').value = MD5('10621:'+ inputfloat +':filya:RUB:'+ document.getElementById('fk-donation-comment').value);
